...
const database = "http://52.66.40.75/box_968b81541942e609e35c/org"

function OrgAcc({ posts }) {
    ...
    return (
        <div className={styles.page}>
            ...
            <form onSubmit={createAccount} className={styles.form}>
                ...
                <input type="text" value={name} onChange={nameChange} className={styles.input} required/>
                <label> Organization Motto </label>
                <input type="text" value={motto} onChange={mottoChange} className={styles.input} required/>
            ...
            <Link href="/newAccount">
                <a className={styles.link}> Personal Account </a> 
            </Link>
